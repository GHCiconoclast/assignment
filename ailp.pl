...
get_assignment_details :-  % get assignment details
    ...
    ; Assignment_part=1 -> use_module(assignment_library('wp_library'), except([api_/1,agent_ask_oracle/4])),
                           use_module(assignment_library(Assignment_library_name), [api_/1,part_module/1,shell/0,start/0,stop/0,query_world/2,possible_query/2,my_agent/1,leave_game/0,join_game/1,start_game/0,reset_game/0,map_adjacent/3,map_distance/3,say/2]),
